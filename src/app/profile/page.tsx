...
// My Profile Component - Only shows current user's info
const MyProfileSection: React.FC<{ user: User }> = ({ user }) => { // Fixed: Changed 'any' to 'User'
    const { updateUserPassword } = useAuth();
    ...
    const handlePasswordChange = (e: React.FormEvent) => {
        ...
        if (profile.newPassword !== profile.confirmPassword) {
            alert("New password doesn't match!"); // Fixed apostrophe
            return;
        }
    ...
    // Function to mask password for display (security improvement)
            ...
            <div className="profile-card">
                ...
                <div className="user-info-display">
                    ...
                    <div className="info-item">
                        <label>Current Password</label>
                        <div className="info-value password-masked">
                            {(user.password)} {/* Added password masking */}
                        </div>
                    </div>
                </div>
