...
// Use the imported AppSettings type directly
type Settings = AppSettings;
type GeneralSettingsData = Pick<Settings, 'theme' | 'language'>;
type ExportSettingsData = Settings['export'];
...
interface ExportSettingsProps {
    ...
    onChange: (updates: Partial<ExportSettingsData>) => void;
}
...
export default function SettingsPage() {
    ...
    const handleGeneralSettingsChange = (updates: Partial<GeneralSettingsData>) => {
        updateSettings(updates);
    };

    const handleExportSettingsChange = (updates: Partial<ExportSettingsData>) => {
        updateSettings({
            export: {
                ...settings.export,
                ...updates
        ...
        <div className="settings-section">
            ...
            <div className="setting-group">
                ...
                <select
                    id="language"
                    value={settings.language}
                    onChange={(e) => onChange({ language: e.target.value as 'en' | 'es' | 'ur' })}
                >
                    {languages.map(lang => (
                        <option key={lang.value} value={lang.value}>
                            {lang.label}
        ...
        <div className="settings-section">
            ...
            <div className="setting-group">
                ...
                <select
                    id="defaultFormat"
                    value={settings.defaultFormat}
                    onChange={(e) => onChange({ defaultFormat: e.target.value as 'csv' | 'excel' | 'pdf' })}
                >
