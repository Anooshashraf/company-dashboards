...
export default function IASReportsPage() {
  ...
  const GOOGLE_SHEETS_URL =
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vS-bdS5OBmBCnQFchjBd_lXcK2MLfoQOvwn02RWYNPVMEOHdIz2g8jG0mXw-tzfMQ/pub?gid=837310373&single=true&output=csv";
  ...
  // Simple search function - like your audit code
  const searchData = useCallback(
    (data: IASReport[], searchTerm: string): IASReport[] => {
      if (!searchTerm.trim()) {
        return data;
      }
      ...
      return data.filter((report) => {
        // Simple field matching like your audit code
        return (
  ...
  // Handle search - automatically navigate to detailed view with filtered results
    ...
    (term: string) => {
      ...
      if (term.trim()) {
        ...
        if (searchResults.length > 0) {
          // Navigate to detailed view with search results
        ...
        // Clear search - go back to regions view
      ...
      <div className="ias-table-block">
        <div className="ias-table-header">
          ...
          <div className="ias-meta">
            {aggregated.length} groups — {getUniqueStoreCount(dataToAggregate)}{" "}
            unique stores — total value ${totalCost.toLocaleString()}
          ...
          <div className="ias-controls-section">
            <div className="ias-controls-grid">
              ...
              <div className="search-box">
                <input
                  type="text"
                  placeholder="Search for markets, store IDs, SKUs, or products..."
                  value={searchTerm}
              ...
              >
                ...
                <div className="modal-body">
                  <div className="detail-grid">
                    ...
                    <div>
                      <strong>Total Cost:</strong> {selectedDetails["Cost"]}
                    </div>
                    <div>
...
//       console.log(
//         `Found ${results.length} results for search: "${searchLower}"`
//       );
//       if (results.length > 0) {
//         console.log(
//           "Sample results:",
...
//   // FIXED: Enhanced search handler with better state management
//   const handleSearch = useCallback(
//     (term: string) => {
...
//         if (searchResults.length > 0) {
//           console.log(
//             `Navigating to detailed view with ${searchResults.length} search results`
//           );
//           // Navigate to detailed view with search results
//           setCurrentData(searchResults);
//           setCurrentView("detailed");
...
//           // Stay in current view but show no results
//           setCurrentData([]);
//           setCurrentView("detailed");
//           setSelectedStore(`Search: "${term}"`);
//           setHistoryStack([
...
//   // FIXED: Add useEffect to handle search term changes automatically
//   useEffect(() => {
//     if (searchTerm.trim()) {
//       handleSearch(searchTerm);
//     }
...
//   // FIXED: Apply search filter to current data
//   const filteredData = useMemo(() => {
//     if (currentView === "detailed" && searchTerm.trim()) {
//       return searchData(currentData, searchTerm);
//     }
//     return currentData;
//   }, [currentData, searchTerm, currentView, searchData]);
...
//                   <input
//                     type="text"
//                     placeholder="Search for TECH IDs, store names, markets, SKUs, or products..."
//                     value={searchTerm}
//                     onChange={(e) => setSearchTerm(e.target.value)}
//                     className="search-input"
//                     style={{
...
//                 >
//                   Try searching: "TECH7404", "Houston", "MOT XT24191", etc.
//                 </div>
//               </div>
//             </div>
//           </div> */}
